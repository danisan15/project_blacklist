    ...
    <div className={styles.contentForm}>
      <form onSubmit={onSubmit}>
        ...
        <article className={styles.inputGroup}>
          ...
          <input type="text" placeholder='Ingresa tu nombre' autoComplete='off' {...register("name", nameOptions)} />
        </article>
        ...
        <article className={styles.inputGroup}>
          ...
          <input type="password" placeholder='Crear contraseña' {...register("password", passwordOptions)} />
        </article>
        {errors.password && <span>{errors.password.message}</span>}

        <article className={styles.inputGroup}>
          <IconsForm type="confirmPassword" />
          <input type="password" placeholder='Confirmar contraseña' {...register("confirmPassword", confirmPasswordOptions)} />
        </article>
        ...
        <FormSwitchLink isSignUp spanText='¿Tienes cuenta?' linkText='Inicia sesión' />
